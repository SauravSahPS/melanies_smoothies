...
session = cnx.session()
my_dataframe = session.table("smoothies.public.fruit_options").select(col('FRUIT_NAME'),col('ORDER_ON'))
...
if ingredients_list:
    ...
    if time_to_insert:
        ...
        st.success('Your Smoothies is ordered, ' + name_order)
